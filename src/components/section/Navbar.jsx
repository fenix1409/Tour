                ...
                <NavLink key={item.id} to={item.path} className={({ isActive }) => `flex items-center gap-[17px] w-[240px] py-[13px] pl-[30px] ${isActive ? "text-[#5350DE] font-semibold" : "text-[#718096]"}`}>
                    {({ isActive }) => (
                        <>
                            <div>
                                {item.id === 2 || item.id === 4 ? (
                                    <img src={item.icon} alt="icon" width={25} height={25} className={isActive ? "filter brightness-0 invert-[40%]" : "filter brightness-0 invert-[60%]"} />
                                ) : (
                                    <item.icon size={25} className={isActive ? "text-[#5350DE]" : "text-[#718096]"} />
                                )}
                            </div>
